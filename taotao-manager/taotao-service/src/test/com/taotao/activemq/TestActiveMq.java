...
/**
 * Created by lenovo on 2018-05-02.
 */
public class TestActiveMq {
    ...
    public void testQueueProducer() throws JMSException{
        ...
        ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://122.114.125.40:61616");
...
//      textMessage.setText("hello,activemq!!!");
        //第二种方式：
        TextMessage textMessage = session.createTextMessage("hello,activemq!!0111111");
        //8.发送消息
...
//      textMessage.setText("hello,activemq!!!");
    ...
    public void testTopicPersistenceProducer() throws JMSException{
        //1.创建一个连接工厂对象ConnectionFactory对象。需要指定mq服务的ip及端口号。注意参数brokerURL的开头是
        //tcp://而不是我们通常的http://，端口是61616而不是我们访问activemq后台管理页面所使用的8161
        ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://122.114.125.40:61616");
        //2.设置使用异步发送消息，这样可以显著提高发送性能
        connectionFactory.setUseAsyncSend(true);
        //3.使用ConnectionFactory创建一个连接Connection对象
        Connection connection = connectionFactory.createConnection();
        //4.对于每一个生产者来说，其clientID的值必须唯一
        connection.setClientID("producer4");
